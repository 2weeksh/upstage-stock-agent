...
class ModeratorAgent:
    def __init__(self, llm):
        try:
            ...
            self.llm = llm 
            print("Moderator: 기본 LLM 모드로 실행됩니다.")
    ...
    def facilitate(self, company_name, history):
        ...
        [사회자의 사고 과정]
        1. **THOUGHT**: 현재 차트, 뉴스, 재무 전문가들의 의견이 하나로 수렴되었는가? 아니면 여전히 쟁점이 있어 더 얘기해야 하는가?
        2. **STATUS**: 
    ...
    def summarize_debate(self, company_name, history):
        ...
        지금까지 오고 간 대화 내용을 객관적이고 중립적인 입장에서 간략히 요약해 주세요.
